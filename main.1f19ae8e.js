...
},{}],"components/Item.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $30133f = exports.default || module.exports;
      
      if (typeof $30133f === 'function') {
        $30133f = $30133f.options;
      }
    
        /* template */
        Object.assign($30133f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "item" }, [
    _c("div", { staticClass: "item-label" }, [_vm._v(_vm._s(_vm.item))]),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "item-delete", on: { click: _vm.onDeleteClick } },
      [_vm._v("삭제")]
    )
  ])
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$30133f', $30133f);
          } else {
            api.reload('$30133f', $30133f);
          }
        }
...
var _Item = _interopRequireDefault(require("./components/Item.vue"));
...
var _default = {
  ...
  methods: {
    addTodo: function addTodo() {
      ...
      this.$store.commit('addTodo', this.addInput);
      this.addInput = '';
    }
  }
};
exports.default = _default;
        var $5c755a = exports.default || module.exports;
      
      if (typeof $5c755a === 'function') {
        $5c755a = $5c755a.options;
      }
    
        /* template */
        Object.assign($5c755a, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "add" }, [
      _c("input", {
        ...
        attrs: { type: "text" },
        domProps: { value: _vm.addInput },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.addInput = $event.target.value
          }
        }
      }),
      _vm._v(" "),
      _c("div", { staticClass: "add-button", on: { click: _vm.addTodo } }, [
        _vm._v("추가")
      ])
    ]),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "items" },
      _vm._l(_vm.$store.state.items, function(item, i) {
        return _c("Item", {
          key: item,
          attrs: { item: item, itemIndex: i },
          on: {
            delete: function($event) {
              _vm.deleteTodo($event)
            }
          }
        })
      }),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5c755a', $5c755a);
          } else {
            api.reload('$5c755a', $5c755a);
          }
        }
...
},{"./components/Item.vue":"components/Item.vue","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/vuex/dist/vuex.esm.js":[function(require,module,exports) {
"use strict";
...
var _default = new _vuex.default.Store({
  ...
  mutations: {
    addItem: function addItem(state, itemName) {
      state.items.push(itemName);
    },
    deleteItem: function deleteItem(state, itemIndex) {
...
exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","vuex":"../node_modules/vuex/dist/vuex.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"App.vue","./store":"store.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
